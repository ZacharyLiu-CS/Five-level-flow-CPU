...
#
# Generated by Vivado on Tue Dec 26 21:02:51 +0800 2017
...
# Script info
echo -e "data_mem.sh - Script generated by export_simulation (Vivado v2016.4 (64-bit)-id)\n"
...
elaborate()
{
  $xv_path/bin/xelab --relax --debug typical --mt auto -L blk_mem_gen_v8_3_5 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot data_mem xil_defaultlib.data_mem xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  $xv_path/bin/xsim data_mem -key {Behavioral:sim_1:Functional:data_mem} -tclbatch cmd.tcl -log simulate.log
}
